...
class Program
{
    static void Main(string[] args)
    {
        ...
        studentManager.AddStudent(new Student { Id = 1, Name = "Alice", Age = 20, Course = "Computer Science" });
        studentManager.AddStudent(new Student { Id = 2, Name = "Bob", Age = 22, Course = "Mathematics" });
        studentManager.AddStudent(new Student { Id = 3, Name = "Charlie", Age = 25, Course = "Computer Science" });
